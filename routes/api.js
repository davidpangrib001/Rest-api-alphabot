...
const Genius = new (require("genius-lyrics")).Client('OofI9p2oQnXMl8InHEoJmOjy5wjR1NEB') // Login/Sign Up in https://genius.com/api-clients# , Copy And Paste Your Access Token
...
router.get('/pastebin', async (req, res) => {
  ...
  pastebin = new PastebinAPI({
                  'api_dev_key' : 'j_k7Wa9K8cP03aShcT1QOCyBxyq_T5sI',
                  'api_user_name' : 'davidpangrib001',
                  'api_user_password' : 'gTNT-?,Ju6rkN(2'
                 });
